...
export default function HomePage() {
  return (
    <>
      ...
      {/* JEE Mains 2023 Results Highlight */}
      <section className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-16">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="section-heading flex items-center justify-center gap-3">
            ...
            IIT म्हणजेच, श्रीगणेश
          </h2>
          <p className="section-subheading">
            JEE Mains 2023 — Phase 1 Results · Outstanding performances by our students
          </p>
          <div className="mt-10 grid items-center gap-8 lg:grid-cols-2">
            <div className="group relative overflow-hidden rounded-2xl border-2 border-blue-200 bg-white shadow-xl transition-all duration-300 hover:shadow-2xl hover:border-blue-400">
              <div className="absolute left-4 top-4 z-10 rounded-full bg-blue-600 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-white shadow-lg">
                🎓 JEE Mains 2023
              </div>
              <Image
                src="/images/jee-mains-2023-results.png"
                alt="Shree Ganesh Junior College JEE Mains 2023 Phase 1 Results — Top scorers"
                width={800}
                height={1000}
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-blue-200 bg-white/80 p-6 shadow-md backdrop-blur-sm">
                <h3 className="font-display text-2xl font-bold text-brand-900">
                  🏆 JEE Mains 2023 — Top Performers
                </h3>
                <p className="mt-2 text-stone-600">
                  Our students delivered <strong>exceptional results</strong> in JEE Mains 2023 Phase 1,
                  with top scorer <strong>Sai Gavali securing 96.05%</strong> and multiple students
                  crossing the <strong>80+ percentile</strong> mark.
                </p>
                <p className="mt-3 text-sm italic text-stone-500">
                  हार्दिक अभिनंदन! — श्रीगणेश ज्युनिअर कॉलेज, कोऱ्हाळे
                </p>
              </div>
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-xl border border-brand-100 bg-white p-4 text-center shadow-sm">
                  <p className="font-display text-2xl font-bold text-blue-600">96.05%</p>
                  <p className="text-xs text-stone-500">Top Score</p>
                </div>
                <div className="rounded-xl border border-brand-100 bg-white p-4 text-center shadow-sm">
                  <p className="font-display text-2xl font-bold text-blue-600">12</p>
                  <p className="text-xs text-stone-500">Qualifiers</p>
                </div>
                <div className="rounded-xl border border-brand-100 bg-white p-4 text-center shadow-sm">
                  <p className="font-display text-2xl font-bold text-blue-600">80%+</p>
                  <p className="text-xs text-stone-500">Avg Percentile</p>
                </div>
              </div>
              <Link href="/results" className="btn-primary inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700">
                View All Results
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
